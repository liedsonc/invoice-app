...
<template>
    <div class="container">
            ...
            <div class="card__content">
                <div class="card__content--header">
                    <div>
                        ...
                        <select name="" id="" class="input" v-model="customer_id">
                            ...
                            <option v-for="customer in allcustomers" :key="customer_id">
                                {{ customer.firstname }}
                            </option>
                        </select>
                    </div>
                ...
                <div class="table">
                    ...
                    <div style="padding: 10px 30px !important;">
                        <button class="btn btn-sm btn__open--modal" @click="handleModal()">
                            Add New Line
                        </button>
                    </div>
                </div>
        ...
        <div class="modal main__modal " :class="{ show: modal }">
            <div class="modal__content">
                <span class="modal__close btn__close--modal" @click="handleModal()">×</span>
                <h3 class="modal__title">Add Item</h3>
                <hr><br>
                <div class="modal__items">
                    <ul style="list-style: none; display: flex; flex: 1; flex-direction: column;">
                    <li v-for="(item, i) in listproducts" :key="item.id" style="display:flex; justify-content: space-between; width: auto;  align-items:center; padding-bottom:5px;">
